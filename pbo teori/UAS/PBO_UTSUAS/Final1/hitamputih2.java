...
public class hitamputih2 {
    ...
    // 1. Metode Main untuk Memuat dan Menyimpan Gambar
        try {
            ...
            ImageIO.write(filteredImage, "jpg", new File("hitamputihgmbr.jpg")); // gambar tersimpan
            System.out.println("");
            System.out.println("berhasil !,  output gambar:'hitamputih.jpg'");
    ...
    //Iterasi Piksel: Mengiterasi setiap piksel gambar untuk memeriksa warna RGB-nya.
