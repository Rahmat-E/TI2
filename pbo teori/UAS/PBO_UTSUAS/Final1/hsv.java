...
class COLOR{
    public static void main(String[] args) {
        // input nilai RGB dengan Scanner
        Scanner input =new Scanner(System.in);
        System.out.print("masukkan nilai rgb Red: ");
        double Red=Double.parseDouble(input.nextLine());
        System.out.print("masukkan nilai rgb green: ");
        double Green=Double.parseDouble(input.nextLine());
        System.out.print("masukkan nilai rgb Blue: ");
        double Blue=Double.parseDouble(input.nextLine());System.out.println();
        ...
        System.out.println("nilai red setelah dikonversi 0-1: "+rgb[1]);
        System.out.println("nilai red setelah dikonversi 0-1: "+rgb[2]);System.out.println();
        ...
        double delta=MAX-MIN;System.out.println();
        // menghitung hue
