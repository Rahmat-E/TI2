...
public class hitamputih {
    ...
    public static void main(String[] args) {
        String imagePath = "C:\\Users\\r687e\\Desktop\\Neatbeans21\\double.jpg";
        String outputPath = "path/to/output_binary_image.jpg";
        String color = "red"; // Ubah sesuai dengan warna yang diinginkan: red, blue, yellow,
