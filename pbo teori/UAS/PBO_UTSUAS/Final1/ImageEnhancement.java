...
public class ImageEnhancement {
    public static void main(String[] args) {
        try {
            ...
            ImageIO.write(enhancedImage, "jpg", new File("IMGenhanced_traffic_sign.jpg"));
            System.out.println("Image enhancement completed successfully: 'IMGenhanced_traffic_sign.jpg'");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static BufferedImage enhanceImage(BufferedImage image) {
        BufferedImage result = histogramEqualization(image);
